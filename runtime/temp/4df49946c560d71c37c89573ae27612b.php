<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:108:"C:\Users\Administrator\Desktop\phpEnv5.6.0-Green\www\lizi\public/../application/admin\view\motels\index.html";i:1566785497;s:101:"C:\Users\Administrator\Desktop\phpEnv5.6.0-Green\www\lizi\application\admin\view\template\layout.html";i:1567134813;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-body">
                <form class="form-inline" name="searchForm" id="searchForm" action="<?php echo url('motels/index'); ?>" method="GET">
                    <div class="form-group">
                        <input value="<?php echo \think\Request::instance()->get('keywords')?\think\Request::instance()->get('keywords') : '' ;; ?>"
                               name="keywords" id="keywords" class="form-control input-sm" placeholder="模板名称">
                    </div>
            ...
            <div class="box-body table-responsive">
                ...
                <table class="table table-hover table-bordered datatable" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="td-do">
                            <a href="<?php echo url('motels/edit',array('id'=>$vo['id'])); ?>"
                               class="btn btn-primary btn-xs" title="修改">
                                <i class="fa fa-pencil">编辑</i>
                            </a>
                            <a class="btn btn-danger btn-xs " href="<?php echo url('motels/del',array('id'=>$vo['id'])); ?>" >
