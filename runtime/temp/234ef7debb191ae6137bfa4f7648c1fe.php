<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:109:"C:\Users\Administrator\Desktop\phpEnv5.6.0-Green\www\lizi\public/../application/index\view\mobile\search.html";i:1577072461;s:103:"C:\Users\Administrator\Desktop\phpEnv5.6.0-Green\www\lizi\application\index\view\public\mobilehead.html";i:1576225073;}*/ ?>
<html>
<head>
...
<div class="msg w">
    ...
    <div class="msg_content">总价<?php echo $vo['countpay']; ?> 元 数量<?php echo $vo['num']; ?>个
        <?php if($vo['status'] == 1): ?>
        <a href="/tika?id=" title="点击查看卡密" target="_blank">
        ...
        【<a href="/jxgoumai?id=" target="_blank" >付款</a>】
        <?php else: ?>
