                ...
                <form class="form-inline" name="searchForm" id="searchForm" action="" method="GET">
                    ...
                    <div class="form-group">
                        <select name="user_id" class="form-control input-sm">
                            ...
                            <?php if(is_array($user_list) || $user_list instanceof \think\Collection || $user_list instanceof \think\Paginator): if( count($user_list)==0 ) : echo "" ;else: foreach($user_list as $key=>$user): ?>
                            <option value="<?php echo $user['id']; ?>" <?php if(isset($user_id)&&
                                    $user_id==$user['id']): ?>selected<?php endif; ?>><?php echo $user['nickname']; ?>(<?php echo $user['name']; ?>)
                            </option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <input value="<?php echo !empty($title)?$title : '' ;; ?>"
            ...
            <div class="box-body table-responsive no-padding">
                <table class="table table-hover table-bordered">
                    ...
                    <tr>
                        ...
                        <td><?php echo $list->adminuser['name']; ?></td>
                        <td><?php echo $list['title']; ?></td>
                        <td><?php echo $list['log_url']; ?></td>
                        <td><?php echo $list['log_type']; ?></td>
                        <td><?php echo $list['log_ip']; ?></td>
                        <td><?php echo $list['create_time']; ?></td>
                        <td class="td-do">
                            <a data-id="<?php echo $list['id']; ?>" data-url="view" data-confirm="2" data-type="2"
