<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:107:"C:\Users\Administrator\Desktop\phpEnv5.6.0-Green\www\lizi\public/../application/admin\view\goods\klist.html";i:1567388255;s:101:"C:\Users\Administrator\Desktop\phpEnv5.6.0-Green\www\lizi\application\admin\view\template\layout.html";i:1567134813;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <form class="form-inline" name="searchForm"  method="GET">
                        ...
                        <div class="input-group">
                            <select name="gid" id="gid" class="form-control">
                                ...
                                <?php if(is_array($goods_cates) || $goods_cates instanceof \think\Collection || $goods_cates instanceof \think\Paginator): $i = 0; $__LIST__ = $goods_cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $vo['id']; ?>" <?php if(\think\Request::instance()->get('gid') == $vo['id']): ?> selected="" <?php endif; ?>><?php echo $vo['title']; ?></option>
                    ...
                    <div class="input-group">
                        <select name="over" id="over" class="form-control">
                            <option value="0" <?php if(\think\Request::instance()->get('over') == 0): ?> selected="" <?php endif; ?>>未使用</option>
                            <option value="1" <?php if(\think\Request::instance()->get('over') == 1): ?> selected="" <?php endif; ?>>已使用</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <button data-href="<?php echo url('goods/klist'); ?>" class="btn btn-sm btn-success search" type="button"><i class="fa fa-search"></i> 查询
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="box-body table-responsive">
                ...
                <table class="table table-hover table-bordered datatable" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="td-do">
                            <a href="<?php echo url('goods/addk',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-xs" >
                                <i class="fa fa-pencil">编辑</i>
                            </a>
                            <a class="btn btn-danger btn-xs"  href="<?php echo url('goods/delk',array('id'=>$vo['id'])); ?>">
