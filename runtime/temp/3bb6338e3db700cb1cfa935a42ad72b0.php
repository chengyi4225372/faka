...
<div id="errorbg">
    ...
    <div class="reg">
        ...
        <div class="from">
            <div align="center">
                <a  class="button button-3d button-primary button-rounded button-small"   value="" />查看卡密</a>
                <a  class="button button-3d button-highlight button-rounded button-small"  value=""/>下载文件</a>
            </div>

        </div>
        <div class="wu"></div> <br/>
        <div class="from">
        <div align="center"><font color="#FF0000">注意事项：网站定期清理过期订单，请注意存档，以免丢失</div>
    </div>
    </div>

</div>

<div class="wu"></div><div class="wu"></div>
<div class="wu"></div><div class="wu"></div>
<div class="wu"></div><div class="wu"></div><div class="wu">
