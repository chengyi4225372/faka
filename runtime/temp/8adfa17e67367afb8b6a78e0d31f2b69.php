...
<div id="bd">
    ...
    <div id="bar">
        ...
        <ul id="bar_ul">
            <li class="va" ><a href="<?php echo url('configcom/about'); ?>">关于我们</a></li>
            <li ><a href="<?php echo url('configcom/address'); ?>">兑换地址</a></li>
            <li ><a href="<?php echo url('configcom/help'); ?>">帮助中心</a></li>
        </ul>
    </div>
