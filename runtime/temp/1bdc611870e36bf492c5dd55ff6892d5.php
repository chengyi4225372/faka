<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:105:"C:\Users\Administrator\Desktop\phpEnv5.6.0-Green\www\lizi\public/../application/admin\view\pay\index.html";i:1571218479;s:101:"C:\Users\Administrator\Desktop\phpEnv5.6.0-Green\www\lizi\application\admin\view\template\layout.html";i:1567134813;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="fields-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-md-4">
                                <div class="input-group">
                                    ...
                                    <input id="pid" name="pid" value="<?php echo $info['pid']; ?>" class="form-control" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input id="keys" name="keys" value="<?php echo $info['key']; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input id="url" name="url" value="<?php echo $info['url']; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
        ...
        $.post(url,{'id':id,'url':urls,'pid':pid,'key':keys},function(ret){
            ...
            if(ret.code == 200){
                layer.msg(ret.msg,{time:2000},function(){
                    parent.location.href="<?php echo url('pay/index'); ?>";
                });
            };
